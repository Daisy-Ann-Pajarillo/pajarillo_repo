...
n
#Describe its output.
# The output display from -5 up to 5
...
num
#Describe the output
# The output jump or add by 0.2. This is the output[1] 1.0 1.2 1.4 1.6 1.8 2.0 2.2 2.4 2.6 2.8 3.0, it start in number 1 and then jump or add by 0.2 until it reach the number 3 
...
num4
# Output. 
#[1] 28 22 36 27 18 52 39 42 29 35 31 27 22 37 34 19 20 57 49 50 37 46 25 17 37 43 53 41 
#[29] 51 35 24 33 41 53 40 18 44 38 41 48 27 39 19 30 61 54 58 26
...
average <- weighted.mean(price, purchase)
average
